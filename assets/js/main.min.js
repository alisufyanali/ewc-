        ...
        return (
            get_taxes_dropdown_template(t, n.taxname).done(function (e) {
                ...
                0 < t.length &&
                    ...
                    (p += '<td class="discs"><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="newitems[' + _ + '][discount]" value="" class="form-control">'),    
