...
function get_datatable_buttons(table) {
    ...
    if (app.user_language.toLowerCase() == 'persian' || app.user_language.toLowerCase() == 'arabic') {
        if ($('body').find('#amiri').length === 0) {
            ...
            var mapjst = document.createElement('script');
            mapjst.setAttribute('src', 'https://cdn.datatables.net/buttons/2.2.3/js/buttons.colVis.min.js');
            document.head.appendChild(mapjst);
