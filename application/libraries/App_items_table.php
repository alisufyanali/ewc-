...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            $itemHTML .= '</td>';
            $itemHTML .= '<td align="right" width="7%">'.$item['feet'].'</td>';
            $itemHTML .= '<td align="right" width="7%">'.$item['meter'].'</td>';
             ...
             * Item quantity
             */
            $itemHTML .= '<td align="right" width="7%">' . floatVal($item['qty']);
            ...
            $itemHTML .= '<td align="right" width="8%">'.number_format($item['discount'],0).'</td>';
    ...
    public function html_headings()
    {
        ...
        // $html .= '<th align="right">Description</th>';
        $html .= '<th align="right">Feet</th>';
        $html .= '<th align="right">Meter</th>';
