...
class Clients extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->load->model('invoices_model');
        $data['area_statuses'] = $this->invoices_model->get_area();
        $data['dates_statuses'] = $this->invoices_model->get_monthsofcustomers();

        $data['salepersons'] = $this->invoices_model->get_salepersons();
        $data['sources'] = $this->invoices_model->get_sources();
        $data['requirements'] = $this->invoices_model->get_requirements();
        $data['product_category'] = $this->invoices_model->get_product_category();
    ...
    public function vendorstatement_pdf()
    {
        $customer_id = $this->input->get('customer_id');
        ...
        $data['statement'] = $this->clients_model->vendor_statements($customer_id, to_sql_date($from), to_sql_date($to));
    ...
    public function vendor_statement()
    {
        ...
        $viewData['html'] = $this->load->view('admin/clients/groups/vendor_statement', $data, true);
