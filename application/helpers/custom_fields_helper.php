...
function getFeet($Accoutname){
    $CI = & get_instance();
    $information = $CI->db->query("SELECT * FROM `tblitems` WHERE description = '".$Accoutname."'")->row();
    return $information->Feet;
}

function getMeter($Accoutname){
    $CI = & get_instance();
    $information = $CI->db->query("SELECT * FROM `tblitems` WHERE description = '".$Accoutname."'")->row();
    return $information->Meters;
}
