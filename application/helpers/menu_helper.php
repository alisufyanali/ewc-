...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_children_item('manufacturing', [
            ...
            'href'     => admin_url('Misc/manage_bom'),
            'position' => 5,
            'badge'    => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('manufacturing', [
            'slug'     => 'bom',
            'name'     => 'Manage Routing',
            'href'     => admin_url('Misc/managerouting'),
            'position' => 5,
            'badge'    => [],
    ]);
    
    $CI->app_menu->add_sidebar_children_item('sales', [
            'slug'     => 'wa_manage_return',
            'name'     => 'Purchase Return',
            'icon'     => 'fa fa-object-ungroup',
            'href'     => admin_url('warehouse/manage_return'),
            'position' => 7,
        ]);
    ...
    $CI->app_menu->add_sidebar_children_item('manufacturing', [
            'slug'     => 'bom',
            'name'     => 'Work Centers',
            'href'     => admin_url('Misc/workcenter'),
            'position' => 5,
            'badge'    => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('manufacturing', [
            ...
            'href'     => admin_url('Misc/manageworkcenter'),
            'position' => 5,
            'badge'    => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('manufacturing', [
            ...
            'href'     => admin_url('Misc/manufacturing_orders'),
            'position' => 5,
            'badge'    => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('sales', [
            'slug'     => 'manage_carpetservices',
            'name'     => "Carpet Services",
            'href'     => admin_url('misc/manage_carpetservices'),
            'position' => 5,
            'badge'    => [],
    ]);  
    ...
    $CI->app_menu->add_sidebar_children_item('sales', [
            'slug'     => 'manage_approved_products',
            'name'     => "Approved Products",
            'href'     => admin_url('misc/manage_approved_products'),
            'position' => 5,
            'badge'    => [],
    ]); 
    ...
    if ((has_permission('invoices', '', 'view') || has_permission('invoices', '', 'view_own'))
        ...
        $CI->app_menu->add_sidebar_children_item('sales', [
            'slug'     => 'nongstinvoices',
            'name'     => 'Non Posted Invoices',
            'href'     => admin_url('invoices/nongstinvoices'),
            'position' => 15,
            'badge'    => [],
        ]);
        ...
        $CI->app_menu->add_sidebar_children_item('sales', [
            'slug'     => 'waranty',
            'name'     => 'Waranties',
            'href'     => admin_url('invoices/waranty'),
            'position' => 15,
            'badge'    => [],
        ]);
    }
    ...
    if (has_permission('reports', '', 'view')) {
        ...
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'purchase-categorywise-reports',
            'name'     => 'Purchase Report Category Wise',
            'href'     => admin_url('reports/purchase_categorywise'),
            'position' => 5,
            'badge'    => [],
        ]);
        ...
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'purchase-details-reports',
            'name'     => 'Detailed Purchase Report',
            'href'     => admin_url('reports/purchase_detailwise'),
            'position' => 5,
            'badge'    => [],
        ]);
        
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'stock-take-worksheet',
            'name'     => 'Stock Take Worksheet',
            'href'     => admin_url('reports/stock_take_worksheet'),
            'position' => 5,
            'badge'    => [],
        ]);
