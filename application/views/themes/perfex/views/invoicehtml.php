            ...
            <div class="row">
                <div class="col-md-12">
                  ...
                  ?>">
                    ...
                    <select name="transactions_allowed"  id="">
                        <option value="1">Transactions Allow</option>
                        <option value="0">Transactions Not Allow</option>
                    </select>
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <?php
                              foreach ($items->taxes() as $tax) {
                                 echo '<tr class="tax-area"><td class="bold">' . $tax['taxname'] . ' (' . app_format_number($tax['taxrate']) . '%)</td><td>' . app_format_money($invoice->subtotal * $tax['taxrate'] / 100, $invoice->currency_name) . '</td></tr>';
                              }
                              ?>
                            ...
                            <?php if (count($invoice->receivedvouchers) > 0 && get_option('show_total_paid_on_invoice') == 1) { ?>
                            <tr>
                                <td><span class="bold"><?php echo _l('invoice_total_paid'); ?></span></td>
                                <td>
                                    <?php  echo '-' . app_format_money(get_invoice_received_amount($invoice->id), $invoice->currency_name); ?>
                                </td>
                            </tr>
                            <?php } ?>
                ...
                <div class="col-md-12 invoice-html-payments">
                    <?php
                    if(count($invoice->receivedvouchers) ){?>
                    ...
                    <table class="table table-hover invoice-payments-table">
                        ...
                        <tbody>
                            <?php 
                              $receivedvouchers = $invoice->receivedvouchers;
                                 foreach ($receivedvouchers as $received) { 
                                 ?>
                            <tr>
                                <td>
                                ...
                                <td><?php echo _d($received->date); ?></td>
                                <td><?php echo app_format_money($received->credit, $invoice->currency_name); ?></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
