...
foreach ($items->taxes() as $tax) {
    ...
    <td align="right" width="15%">' . app_format_money($invoice->subtotal * $tax['taxrate'] / 100, $invoice->currency_name) . '</td>
</tr>';
}
