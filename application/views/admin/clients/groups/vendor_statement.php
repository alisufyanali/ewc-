         ...
         <tr>
           ...
           <td>
            ...
            if(isset($data['invoice_id'])) {
              echo _l('vendorstatement_invoice_details',array('<a href="https://yaaftpos.com/EWC_NEW/admin/purchase/purchase_order/'.$data['id'].'" target="_blank">'.$data['invoice_id'].'</a>',_d($data['duedate'])));
          ...
          ?>
           ...
           <td><?php echo ($data['rconversion']); ?></td>
           <td class="text-right">
          <?php
          if(isset($data['invoice_id'])) {
