         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                ...
                <div class="form-group" app-field-wrapper="salepersons">
                    <label for="salepersons" class="control-label">Sale Persons</label>
                    <input type="text" id="salepersons" name="salepersons" class="form-control" value="<?php echo $client->salepersons; ?>">
                </div>
                
                <div class="form-group" app-field-wrapper="requirements">
                    <label for="requirements" class="control-label">Requirements</label>
                    <input type="text" id="requirements" name="requirements" class="form-control" value="<?php echo $client->requirements; ?>">
                </div>
                
                <div class="form-group" app-field-wrapper="sources">
                    <label for="sources" class="control-label">Sources</label>
                    <input type="text" id="sources" name="sources" class="form-control" value="<?php echo $client->sources; ?>">
                </div>
                
                <div class="form-group" app-field-wrapper="product_category">
                    <label for="product_category" class="control-label">Product Category</label>
                    <input type="text" id="product_category" name="product_category" class="form-control" value="<?php echo $client->product_category; ?>">
                </div>     
               ...
               <div class="col-md-6">
                  ...
                  <?php $value=( isset($client) ? $client->doa : ''); ?>
                  <?php echo render_input( 'doa', 'Date Of Onboard',$value,'date'); ?>
                  <?php $value=( isset($client) ? $client->city : ''); ?>
                  <?php echo render_input( 'city', 'client_city',$value); ?>
                  <?php $value=( isset($client) ? $client->state : ''); ?>
                  <?php echo render_input( 'state', 'client_state',$value); ?>
                  <?php $value=( isset($client) ? $client->zip : ''); ?>
                  <?php echo render_input( 'zip', 'Area',$value); ?>
