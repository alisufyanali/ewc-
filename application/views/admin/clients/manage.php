         ...
         <div class="col-md-12">
            <div class="_filters _hidden_inputs hidden">
               <?php
                  ...
                  foreach($area_statuses as $status){
                       echo form_hidden('area_'.$status['zip']); 
                  }
                  
                  foreach($dates_statuses as $months){
                       echo form_hidden('fromdate_'.$months['months']); 
                  }
                  
                  
                  foreach($salepersons as $months){
                       echo form_hidden('salepersons_'.str_replace(' ','-',$months['months'])); 
                  }
                  
                  foreach($sources as $months){
                       echo form_hidden('sources_'.str_replace(' ','-',$months['months'])); 
                  }
                  
                  foreach($requirements as $months){
                       echo form_hidden('requirements_'.str_replace(' ','-',$months['months'])); 
                  }
                  
                  foreach($product_category as $months){
                       echo form_hidden('product_category_'.str_replace(' ','-',$months['months'])); 
                  }
            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
                     ...
                     <div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                           ...
                           <li class="dropdown-submenu pull-left invoice">
                              <a href="#" tabindex="-1">Area</a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                 <?php foreach($area_statuses as $status){
                                 ?>
                                 <li>
                                    <a href="#" data-cview="area_<?php echo $status['zip']; ?>" onclick="dt_custom_view('area_<?php echo $status['zip']; ?>','.table-clients','area_<?php echo $status['zip']; ?>'); return false;"><?php echo $status['zip']; ?></a>
                                 </li>
                                 <?php } ?>
                              </ul>
                           </li>
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              <a href="#" tabindex="-1">Create Month</a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                    <?php foreach($dates_statuses as $months){ ?>
                                    <li>
                                      <a href="#" data-cview="fromdate_<?php echo $months['months']; ?>" onclick="dt_custom_view('fromdate_<?php echo $months['months']; ?>','.table-clients','fromdate_<?php echo $months['months']; ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              <a href="#" tabindex="-1">Sales Persons</a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                    <?php foreach($salepersons as $months){ ?>
                                    <li>
                                      <a href="#" data-cview="$requirementss<?php echo str_replace(' ','-',$months['months']); ?>" onclick="dt_custom_view('salepersons_<?php echo str_replace(' ','-',$months['months']); ?>','.table-clients','salepersons_<?php echo str_replace(' ','-',$months['months']); ?>'); return false;">
                                      <?php echo $months['months']; ?>    
                                      </a>
                                 </li>
                                  <?php } ?>
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              <a href="#" tabindex="-1">Sources</a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                    <?php foreach($sources as $months){ ?>
                                    <li>
                                      <a href="#" data-cview="sources_<?php echo str_replace(' ','-',$months['months']); ?>" onclick="dt_custom_view('sources_<?php echo str_replace(' ','-',$months['months']); ?>','.table-clients','sources_<?php echo str_replace(' ','-',$months['months']); ?>'); return false;">
                                      <?php echo $months['months']; ?>    
                                      </a>
                                 </li>
                                  <?php } ?>
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              <a href="#" tabindex="-1">Requirements</a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                    <?php foreach($requirements as $months){ ?>
                                    <li>
                                      <a href="#" data-cview="requirements_<?php echo str_replace(' ','-',$months['months']); ?>" onclick="dt_custom_view('requirements_<?php echo str_replace(' ','-',$months['months']); ?>','.table-clients','requirements_<?php echo str_replace(' ','-',$months['months']); ?>'); return false;">
                                      <?php echo $months['months']; ?>    
                                      </a>
                                 </li>
                                  <?php } ?>
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              <a href="#" tabindex="-1">Product Category</a>
                              <ul class="dropdown-menu dropdown-menu-left">
                                    <?php foreach($product_category as $months){ ?>
                                    <li>
                                      <a href="#" data-cview="product_category_<?php echo str_replace(' ','-',$months['months']); ?>" onclick="dt_custom_view('product_category_<?php echo str_replace(' ','-',$months['months']); ?>','.table-clients','product_category_<?php echo str_replace(' ','-',$months['months']); ?>'); return false;">
                                      <?php echo $months['months']; ?>    
                                      </a>
                                 </li>
                                  <?php } ?>
                  ...
                  <div class="row mbot15 _filters _hidden_inputs hidden" style="display: block !important">
                    <div class="col-sm-6">
                        <label>From Date</label>
                        <input type="date" name="fromdates" id="fromdates" class="fromdates form-control" onchange="smi_custom_view('fromdates','.table-clients','fromdates'); return false;">
                    </div>
                    
                    <div class="col-sm-6">
                        <label>To Date</label>
                        <input type="date" name="todates" id="todates" class="todates form-control" onchange="smi_custom_view('todates','.table-clients','todates'); return false;">
                    </div>
