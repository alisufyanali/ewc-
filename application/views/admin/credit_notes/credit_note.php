 ...
 <div class="row">
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <select id="currency" name="currency" class="selectpicker" data-show-subtext="1" data-base="3" data-width="100%" data-none-selected-text="Non selected" data-live-search="true" tabindex="-98">
            <option value=""></option>
    ...
    <div class="col-md-6">
        ...
        <select id="gsttype" name="gsttype" class="selectpicker" data-show-subtext="1" data-base="3" data-width="100%" data-none-selected-text="Non selected" data-live-search="true" tabindex="-98">
            <option value=""></option>
            <option value="GST" data-subtext="GST">GST</option>
            <option value="NON GST" data-subtext="NON GST">NON GST</option>
        </select>
    </div>
 ...
 <table class="table credite-note-items-table items table-main-credit-note-edit has-calculations no-mtop">
  <thead>
    <tr>
                  ...
                  <th width="10%" align="right" class="qty">Discount</th>
