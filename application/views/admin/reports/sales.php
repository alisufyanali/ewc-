      ...
      <div class="row">
         <div class="col-md-12">
            <div class="panel_s">
                  ...
                  <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <p>
                        ...
                        <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'items-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> Sales Report By Products</a>
                      </p>
                      <hr class="hr-10" />
                      <p>
                      ...
                      <hr class="hr-10" />
                      <p>
                        <a href="#" class="font-medium" onclick="init_report(this,'customers-supplier'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> Supplier Wise Report</a>
                      </p>
               ...
               <?php  $this->load->view('admin/reports/includes/customers-supplier'); ?> 
               </div>
            </div>
         </div>
      </div>
