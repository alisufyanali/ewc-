   ...
   <div class="col-md-6 col-sm-6">
      <h4 class="bold">
        ...
        <a href="<?php echo admin_url('invoices/invoice/'.$invoice->id); ?>">
         ...
         <span id="fbrinvoice-number">
           FBR VERIFICATION NO <?php echo $invoice->fbrinvoiceno; ?>
         </span>
      </a>
   </h4>
   <address>
   ...
   <div class="col-md-5 col-md-offset-7">
      <table class="table text-right">
         <tbody>
            ...
            <tr id="subtotal">
               <td><span class="bold">Freight Charges</span>
               </td>
               <td class="subtotal">
                  <?php echo app_format_money($invoice->freightcharges, $invoice->currency_name); ?>
               </td>
            </tr>
            
            <tr id="subtotal">
               <td><span class="bold">Other Charges</span>
               </td>
               <td class="subtotal">
                  <?php echo app_format_money($invoice->othercharges, $invoice->currency_name); ?>
               </td>
            </tr>
