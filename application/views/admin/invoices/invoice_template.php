   ...
   <div class="panel-body">
         ...
         <div class="col-md-6">
            ...
            <div class="f_client_id">
              <div class="form-group select-placeholder">
                <label for="clientid" class="control-label"><?php echo _l('invoice_select_customer'); ?>        <a href="#" data-toggle="modal" data-target="#customer_item_modal" style="margin-left: 17px;font-size: 20px;">
    <i class="fa fa-plus"></i>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                   <label for="sale_agent" class="control-label">Invoice Type</label>
                <select id="gsttype" name="gsttype" class="selectpicker" data-show-subtext="1" data-base="3" data-width="100%" data-none-selected-text="Non selected" data-live-search="true" tabindex="-98"><option value=""></option><option value="GST" data-subtext="GST" <?php if(isset($invoice) && $invoice->gsttype == 'GST'){echo 'selected';} ?>>POSTED</option><option value="NON GST" data-subtext="NON GST" <?php if(isset($invoice) && $invoice->gsttype == 'NON GST'){echo 'selected';} ?>>NON POSTED</option></select>
               </div>
            </div>
         ...
         <div class="col-md-6">
            <div class="panel_s no-shadow">
               ...
               <div class="row">
                  <div class="col-md-6">
                    <label for="sale_agent" class="control-label">Currency</label>
                    <select id="currency" name="currency" class="selectpicker" data-show-subtext="1" data-base="3" data-width="100%" data-none-selected-text="Non selected" data-live-search="true" tabindex="-98"><option value=""></option><option value="1" data-subtext="$">USD</option><option value="2" data-subtext="€">EUR</option><option value="3" selected="" data-subtext="PKR">PKR</option></select>
                  </div>
                  <div class="col-md-6">
                     <?php
                        $i = 0;
         ...
         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
            <thead>
               <tr>
                  ...
                  <th width="10%" align="left">Feet</th>
                  <th width="10%" align="left">Meter</th>
                  <th width="25%" align="left">SKU Code</th>
                  ...
                  <th width="10%" align="right" class="disc">Discount</th>
            ...
            <tbody>
               <tr class="main">
                  ...
                  <td>
                     <input name="feet" rows="4" class="form-control" placeholder="Feet" style="width: 97px;">
                  </td>
                  <td> 
                     <input name="meter" rows="4" class="form-control" placeholder="Meter" style="width: 97px;">
                  </td>
                  <td>
                     <input name="sku_code" rows="4" class="form-control" placeholder="SKU CODE">
                  </td>
                  <td>
                  ...
                  <td>
                     <input type="number" name="discount" min="0" value="1" class="form-control" placeholder="discount">
                  </td>
               ...
               <?php if (isset($invoice) || isset($add_items)) {
                  ...
                  foreach ($add_items as $item) {
                    ...
                    $table_row .= '<td class="bold feet"><input name="newitems[' . $i . '][feet]" class="form-control" rows="5" value="'.$item['feet'].'" style="width: 97px;" aria-invalid="false"></td>';
                    
                    $table_row .= '<td class="bold meter"><input name="newitems[' . $i . '][meter]" class="form-control" rows="5" value="'.$item['meter'].'" style="width: 97px;" aria-invalid="false"></td>';
                    
                    $table_row .= '<td><textarea name="items[' . $i . '][sku_code]" class="form-control" rows="5" aria-invalid="false">'.$item['sku_code'].'</textarea></td>';
                    ...
                    $table_row .= '<td class="discs"><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity="" name="newitems[' . $i . '][discount]" value="'.$item['discount'].'" class="form-control"></td>';
            ...
            <tbody>
               ...
               <tr>
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold">Freight Charges</span>
                        </div>
                        <div class="col-md-5">
                           <input type="number" data-toggle="tooltip" data-title="Frieghtcharges" value="<?php if(isset($invoice)){echo $invoice->freightcharges; } else { echo 0; } ?>" class="form-control pull-left" name="freightcharges">
                        </div>
                     </div>
                  </td>
                  <td class="fccharges"></td>
               </tr>
               ...
               <tr>
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold">Other Charges</span>
                        </div>
                        <div class="col-md-5">
                           <input type="number" data-toggle="tooltip" data-title="othercharges" value="<?php if(isset($invoice)){echo $invoice->othercharges; } else { echo 0; } ?>" class="form-control pull-left" name="othercharges">
                        </div>
                     </div>
                  </td>
                  <td class="othercharges"></td>
               </tr>
               ...
               <tr>
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                           <span class="bold">Conversion Rate in PKR</span>
                        </div>
                        <div class="col-md-5">
                           <input type="number" data-toggle="tooltip" id="conversionrate" data-title="Conversion Rate in PKR" value="<?php if(isset($invoice)){echo $invoice->conversionrate; } else { echo 0; } ?>" class="form-control pull-left" name="conversionrate">
                        </div>
                     </div>
                  </td>
                  <td class="Coversionrate">PKR 0.00</td>
               </tr>
