    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="f_client_id">
                    <div class="form-group select-placeholder">
                        <label for="clientid" class="control-label"><?php echo _l('invoice_select_customer'); ?> <a
                                href="#" data-toggle="modal" data-target="#customer_item_modal"
                                style="margin-left: 17px;font-size: 20px;">
            ...
            if(!isset($invoice_from_project)){ ?>
                <div
                    class="form-group select-placeholder projects-wrapper<?php if((!isset($invoice)) || (isset($invoice) && !customer_has_projects($invoice->clientid))){ echo (isset($customer_id) && (!isset($project_id) || !$project_id)) ?  ' hide' : '';} ?>">
                  ...
                  if(isset($invoice)){
                   ...
                   ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="gsttype" name="gsttype" class="selectpicker" data-show-subtext="1" data-base="3"
                            data-width="100%" data-none-selected-text="Non selected" data-live-search="true"
                            tabindex="-98">
                            <option value=""></option>
                            <option value="GST" data-subtext="GST"
                                <?php if(isset($invoice) && $invoice->gsttype == 'GST'){echo 'selected';} ?>>POSTED
                            </option>
                            <option value="NON GST" data-subtext="NON GST"
                                <?php if(isset($invoice) && $invoice->gsttype == 'NON GST'){echo 'selected';} ?>>NON
                                POSTED</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="panel_s no-shadow">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <select id="currency" name="currency" class="selectpicker" data-show-subtext="1"
                                data-base="3" data-width="100%" data-none-selected-text="Non selected"
                                data-live-search="true" tabindex="-98">
                                <option value=""></option>
                                <option value="1" data-subtext="$">USD</option>
                                <option value="2" data-subtext="€">EUR</option>
                                <option value="3" selected="" data-subtext="PKR">PKR</option>
                            </select>
                        </div>
                        <div class="col-md-3">
            ...
            <table class="table text-right">
                <tbody>
                    ...
                    <tr id="discount_area">
                        ...
                        <td class="discount-total"> <span id="total-discount"></span></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="row">
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="number" data-toggle="tooltip" data-title="Frieghtcharges"
                                        value="<?php if(isset($invoice)){echo $invoice->freightcharges; } else { echo 0; } ?>"
                                        class="form-control pull-left" name="freightcharges">
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="number" data-toggle="tooltip" data-title="othercharges"
                                        value="<?php if(isset($invoice)){echo $invoice->othercharges; } else { echo 0; } ?>"
                                        class="form-control pull-left" name="othercharges">
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <input type="number" data-toggle="tooltip" id="conversionrate"
                                        data-title="Conversion Rate in PKR"
                                        value="<?php if(isset($invoice)){echo $invoice->conversionrate; } else { echo 0; } ?>"
                                        class="form-control pull-left" name="conversionrate">
                                </div>
                            </div>
