      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="panel_s no-shadow">
               ...
               <div class="form-group mbot15 select-placeholder" style="display: none !important">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div style="display: none !important" class="form-group select-placeholder"<?php if(isset($invoice) && !empty($invoice->is_recurring_from)){ ?> data-toggle="tooltip" data-title="<?php echo _l('create_recurring_from_child_error_message', [_l('invoice_lowercase'),_l('invoice_lowercase'), _l('invoice_lowercase')]); ?>"<?php } ?>>
                     ...
                     <div class="form-group select-placeholder">
                        ...
                        <select name="discount_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           ...
                           <option value="before_tax" <?php
                              if(isset($invoice)){ if($invoice->discount_type == 'before_tax'){ echo 'selected'; }} ?> selected><?php echo _l('discount_type_before_tax'); ?></option>
