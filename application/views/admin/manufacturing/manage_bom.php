                        ...
                        <table class="table dataTables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="http://localhost/ewc-/admin/misc/delete_bom/<?php echo $totalbom['gatepassid'] ?>"
                                            class="btn btn-danger">DELETE</a>
                                        <a href="http://localhost/ewc-/admin/misc/bom/<?php echo $totalbom['gatepassid'] ?>"
                                            class="btn btn-info">EDIT</a>
                                        <a href="http://localhost/ewc-/admin/misc/print_gatepass/<?php echo $totalbom['gatepassid'] ?>"
