...
class Clients_model extends App_Model
{
    ...
    public function get_vendor($id = '')
    {
        ...
        return $result = $this->db->get(db_prefix() . 'pur_vendor')->row();
    }
    ...
    {
        return $this->statement_model->vendor_statements($customer_id, $from, $to);
    }
    ...
    public function get_vendor_default_currency($id)
    {
        $this->db->select('default_currency');
        $this->db->where('userid', $id);
