...
class Invoice_items_model extends App_Model
{
    ...
    public function get($id = '')
    {
        ...
        $this->db->select($rateCurrencyColumns . '' . db_prefix() . 'items.id as itemid,rate,' . db_prefix() . 'items.*,
            ...
            description,sku_code,long_description,' . db_prefix() . 'items.group_id,' . db_prefix() . 'items_groups.name as group_name,unit,sub_group_name');
    ...
    public function search($q)
    {
        ...
        foreach ($items as $key => $item) {
            ...
            $items[$key]['name']    = $item['commodity_code'] . ' (' . app_format_number($item['rate']) . ') ' . $item['name'];
        }
