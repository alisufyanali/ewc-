...
var dataObject = [
    ...
    console.log(<?php echo json_encode($taxes); ?>);
...
hot.addHook('afterChange', function(changes, src) {
	if(changes !== null){
        ...
        if(newValue != ''){
            ...
            hot.setDataAtCell(row,7, (newValue*parseFloat(hot.getDataAtCell(row,8)))/100 );
           ...
           var total_money = 0;
            for (var row_index = 0; row_index <= 40; row_index++) {
              if(parseFloat(hot.getDataAtCell(row_index, 8)) > 0){
                total_money += (parseFloat(hot.getDataAtCell(row_index, 8)));
              }
            }
