            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
                     ...
                     <a href="<?php echo admin_url('purchase/vendorimport'); ?>" class="btn btn-primary mright5 test pull-left display-block">Upload CSV</a>
                     <!--<a href="<?php echo admin_url('purchase/vendorimport'); ?>" class="btn btn-info mright5 test pull-left display-block">-->
                     <!--Vendor Import</a>-->
