...
<div class="col-md-12">
    <h4><?php echo _l('vendor_statement_for',get_vendor_name($client->userid)); ?></h4>
</div>
<div class="clearfix"></div>
            ...
            <div class="row">
               ...
               <div class="col-md-7">
                   <address>
                    ...
                    <?php echo get_vendor_name($client->userid); ?>
                 </address>
             </div>
...
<script>
    ...
    var statementUrl = admin_url+'clients/vendor_statement';
    ...
    $.get(statementUrl,function(response){
        ...
        $('#statement_pdf').attr('href',buildUrl(admin_url+'clients/vendorstatement_pdf',statementUrlParams));
        ...
        $('#statement_print').attr('href',buildUrl(admin_url+'clients/vendorstatement_pdf',statementUrlParams));
