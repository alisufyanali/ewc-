...
class Warehouse_model extends App_Model {
     ...
     * @return [type]                    
     */
    public function create_goods_receipt_row_template($warehouse_data = [], $name = '', $commodity_name = '', $warehouse_id = '', $quantities = '', $unit_name = '', $unit_price = '', $taxname = '', $lot_number = '', $date_manufacture = '', $expiry_date = '', $commodity_code = '', $unit_id = '', $tax_rate = '', $tax_money = '', $goods_money = '', $note = '', $item_key = '',$feet = '',$Meter  = '',$SKU  = '',$Description = '', $sub_total = '', $tax_name = '', $tax_id = '', $is_edit = false) {
...
// 			$Description = $name . '[Description]';
		...
		$row .= '<td><input type="text" id="feet" name="feet" class="form-control" value="'.$feet.'"></td>';
