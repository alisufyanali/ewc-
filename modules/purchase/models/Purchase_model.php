...
{   
    ...
    public function add_pur_order($data){
        ...
        $data['vendor'] = $data['supplier_code'];
        ...
        $data['subtotal'] = $data['total_goods_money'];
        unset($data['total_goods_money']);
        
        
        $data['subtotal'] = $data['total_goods_money'];
        unset($data['total_goods_money']);
        
        $data['total'] = $data['total_money'];
        unset($data['total_money']);
        
        
        $data['total_tax'] = $data['total_tax_money'];
        unset($data['total_tax_money']);
        unset($data['value_of_inventory']);
        ...
        if ($insert_id) {
           ...
           foreach ($inventory_receipts as $inventory_receipt) {
				...
				$inventory_receipt['pur_order'] = $insert_id;
                ...
                $inventory_receipt['description'] = $inventory_receipt['commodity_name'];
                unset($inventory_receipt['commodity_name']);
                
                $inventory_receipt['quantity'] = $inventory_receipt['quantities'];
                unset($inventory_receipt['quantities']);
                
                $inventory_receipt['item_code'] = $inventory_receipt['commodity_code'];
                unset($inventory_receipt['commodity_code']);
                
                $inventory_receipt['tax'] = $inventory_receipt['tax_money'];
                unset($inventory_receipt['tax_money']);
                
                $inventory_receipt['unit_price'] = $inventory_receipt['goods_money'];
                unset($inventory_receipt['goods_money']);
                
                $inventory_receipt['total'] = $inventory_receipt['sub_total'];
                unset($inventory_receipt['sub_total']);
                
                // commodity_code     
                
                unset($inventory_receipt['note']);
                unset($inventory_receipt['tax_name']);
                unset($inventory_receipt['date_manufacture']);
                unset($inventory_receipt['expiry_date']);
                unset($inventory_receipt['tax_rate']);
                
                

				$this->db->insert(db_prefix() . 'pur_order_detail', $inventory_receipt);
    ...
    public function add_payment($data, $pur_order){
        ...
        $this->upload->do_upload('attachmentsid');
        ...
        $data['attachmentsid'] = $datas['upload_data']['orig_name'];
    ...
    public function get_payment_by_vendor($vendor){
        return  $this->db->query('select pop.pur_order, pop.id as pop_id, pop.amount, pop.date, pop.paymentmode, pop.transactionid, po.goods_receipt_code as pur_order_name from '.db_prefix().'pur_order_payment pop left join '.db_prefix().'goods_receipt po on po.id = pop.pur_order where po.supplier_code = '.$vendor)->result_array();
    }
