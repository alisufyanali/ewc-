<script>
  ...
  (function($) {
    ...
    var ProposalServerParams = {
      ...
      "subgroup_ft": "[name='subgroup_filter[]']",
      "group_ft": "[name='group_filter[]']",
      "qty_ft": "[name='qty_filter']",
...
warehouse_type_value = warehouse_type;
  ...
  var expenseDropzone;
   ...
   function expenseSubmitHandler(form){
    ...
    data.Breadth = $('input[name="Breadth"]').val();
    data.Feet = $('input[name="Feet"]').val();
    data.Meters = $('input[name="Meters"]').val();
    ...
    data.initail_quantity = $('input[name="initail_quantity"]').val();
    ...
    function edit_commodity_item(invoker){
      ...
      $('#commodity_list-add-edit input[name="initail_quantity"]').val($(invoker).data('iq'));
      $('#commodity_list-add-edit input[name="as_of_date"]').val($(invoker).data('asofdate'));
      ...
      $('#commodity_list-add-edit input[name="Meters"]').val($(invoker).data('meters'));
      $('#commodity_list-add-edit input[name="Breadth"]').val($(invoker).data('breadth'));
      $('#commodity_list-add-edit input[name="Width"]').val($(invoker).data('width'));
      $('#commodity_list-add-edit input[name="Feet"]').val($(invoker).data('feet'));
      $('#commodity_list-add-edit input[name="Height"]').val($(invoker).data('height'));
...
function holdtheproduct(id) {
  "use strict";

    $("#modal_wrapper").load("<?php echo admin_url('warehouse/warehouse/add_hold_stock'); ?>", {
         slug: 'add',
         id:id,
    }, function() {

      $("body").find('#HoldModal').modal({ show: true, backdrop: 'static' });
