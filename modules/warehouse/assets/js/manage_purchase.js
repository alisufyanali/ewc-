...
var manage_purchase_returndata = $('.table-manage_purchase_returndata');

initDataTable(manage_purchase_returndata, admin_url+'warehouse/manage_purchase_returndata', [], [], GoodsreceiptParams, [0, 'desc']);
...
$('.purchase_sm').DataTable().columns([0]).visible(false, false);
 ...
 $('#date_add').on('change', function() {
  ...
  init_goods_return();
  function init_goods_return(id) {
    "use strict";
    load_small_table_item_proposal(id, '#purchase_sm_view', 'purchase_id', 'warehouse/view_purchasereturn', '.purchase_sm');
  }
