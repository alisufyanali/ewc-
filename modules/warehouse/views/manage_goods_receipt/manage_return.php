            ...
            <div class="col-md-12" id="small-table">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">    
                            <div class="_buttons col-md-3">
                                <a href="<?php echo admin_url('warehouse/manage_goods_return'); ?>"class="btn btn-info pull-left mright10 display-block">
                    ...
                    <?php render_datatable(array(
                        ...
                        _l('total_money'),
                        _l('status_label'),
                        ),'manage_purchase_returndata',['purchase_sm' => 'purchase_sm']); ?>
