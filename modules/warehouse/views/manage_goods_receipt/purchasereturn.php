	...
	<div class="content">
		<div class="row">
			<div class="col-md-12" id="small-table">
				<div class="panel_s">
					<?php echo form_open_multipart(admin_url('warehouse/manage_goods_return'), array('id'=>'add_goods_return')); ?>
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<h4 class="no-margin font-bold"><i class="fa fa-clone menu-icon menu-icon" aria-hidden="true"></i> Purchase Return</h4>
								<hr>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								$goods_receipt_code = str_replace('PUR','PR-',$goods_receipt_code);
								
								?>
								<?php echo render_input('goods_receipt_code', 'Purchase Return Number',$goods_receipt_code,'',array('disabled' => 'true')) ?>
							</div>
							<div class="col-md-3">
								<?php $date_c =  isset($goods_receipt) ? $goods_receipt->date_c : $current_day?>
								<?php echo render_date_input('date_c','Return Date', _d($date_c)) ?>
							</div>
							<div class="col-md-3">
							...
							<div class=" col-md-3" > 
								<div class="form-group">
									...
									<select name="currency" class="selectpicker" id="currency" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
										<?php foreach(get_currencies_all() as $s){ ?>
