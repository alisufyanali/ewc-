   ...
   <div class="panel_s">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                       <div class="pull-right _buttons">
                           ...
                           <input type="file" name="attachments" class="form-control" style="width: 86%;display: inline-block;">
          ...
          <div class="col-md-12 panel-padding">
            <table class="table border table-striped table-margintop" >
              <tbody>
                 ...
                 <tr class="project-overview">
                    <td class="bold" width="30%">Purchase Date</td>
                    <td><?php echo html_entity_decode(date('d-m-Y',strtotime($goods_receipt->date_add))) ; ?></td>
                 </tr>
                      ...
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                             ...
                             <li>
                                ...
                                <a href="<?php echo admin_url('warehouse/edit_purchase/'.$goods_receipt->id); ?>" target="_blank">
                                <?php echo _l('print'); ?>
                                </a>
                             </li>
                          </ul>
                           ...
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                              <thead>
                                 <tr>
                                    ...
                                    <th align="right" colspan="1">Tax</th>
                             ...
                             if(is_numeric($receipt_value['unit_id'])){
                              ...
                              if(strlen($commodity_name) == 0){
                                ...
                                $subgroupid =  get_commodity_name($receipt_value['commodity_code'])->group_id;

                            ?>
          
                            <tr>
                              <td><?php echo html_entity_decode($receipt_key) ?></td>
                              <td><?php echo get_category_name($subgroupid)->name ?> - <?php echo html_entity_decode($commodity_name) ?></td>
                              <td><?php echo html_entity_decode(get_commodity_name($receipt_value['commodity_code'])->Feet) ?></td>
                              <td><?php echo html_entity_decode(get_commodity_name($receipt_value['commodity_code'])->Meters) ?></td>
                              ...
                              <td class="text-right"><?php echo app_format_money((float)$receipt_value['discount'],'') ?></td>
                      ...
                      <table class="table text-right table-margintop">
                        <tbody>
                          <tr class="project-overview">
                            ...
                            <?php $total_discount = (isset($goods_receipt) ? $goods_receipt->discount : '');?>
                            <?php $total_goods_money = (isset($goods_receipt) ? $goods_receipt->total_goods_money : '');?>

                            <td><?php echo app_format_money((float)($total_goods_money+$total_discount), getVendorCurrency($goods_receipt->supplier_code)); ?></td>
                          </tr>    
                          <tr class="project-overview">
                            <td class="td_style"><span class="bold"><?php echo _l('discount'); ?></span>
                            </td>
                            <?php $total_discount = (isset($goods_receipt) ? $goods_receipt->discount : '');?>
                            <td><?php echo app_format_money((float)$total_discount, getVendorCurrency($goods_receipt->supplier_code)); ?></td>
                          </tr>
                          <tr class="project-overview" id="subtotal">
                            <td class="td_style"><span class="bold"><?php echo _l('total_goods_money'); ?></span>
                            </td>
                            <?php $total_goods_money = (isset($goods_receipt) ? $goods_receipt->total_goods_money : '');?>
                            <td><?php echo app_format_money((float)$total_goods_money, getVendorCurrency($goods_receipt->supplier_code)); ?></td>
                          </tr>
                          ...
                          <tr class="project-overview">
                            ...
                            <td><?php echo app_format_money((float)$value_of_inventory, getVendorCurrency($goods_receipt->supplier_code)); ?></td>
                          </tr>
                          ...
                          <tr class="project-overview">
                            ...
                            <td><?php echo app_format_money((float)$total_tax_money, getVendorCurrency($goods_receipt->supplier_code)); ?></td>
                          </tr>
                          
                          <tr class="project-overview">
                            <td class="td_style"><span class="bold">Value After Convertion</span>
                            </td>
                            <?php $subtotals = (isset($goods_receipt) ? $goods_receipt->total_money : '');?>
                            <td><?php echo app_format_money((float)$subtotals * $goods_receipt->rconversion, "PKR "); ?></td>
                          </tr>
                          ...
                          <tr class="project-overview">
                            ...
                            <td><?php echo app_format_money((float)$total_money, getVendorCurrency($goods_receipt->supplier_code)); ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
    ...
    <?php } ?>
            ...
            <div role="tabpanel" class="tab-pane" id="payment_record">
               ...
               <h4 class="font-medium mbot15 bold text-success"><?php echo 'Payment For Purchase '. $goods_receipt->goods_receipt_code; ?></h4>
               </div>
               <div class="col-md-6 padr_div_0">
               <a href="#" onclick="add_payment(<?php echo html_entity_decode($goods_receipt->id); ?>); return false;" class="btn btn-success pull-right"><i class="fa fa-plus"></i><?php echo ' '._l('payment'); ?></a>
               </div>
               <div class="clearfix"></div>
    ...
    <div class="modal-dialog dialog_30" >
        <?php echo form_open_multipart(admin_url('purchase/add_payment/'.$goods_receipt->id),array('id'=>'purorder-add_payment-form')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <?php echo render_input('amount','amount','','text',array('data-type' => 'currency')); ?>
                        ...
                        <div class="form-group" app-field-wrapper="transactionid">
                            <label for="attachments" class="control-label">Attachment</label>
                            <input type="file" id="attachmentsid" name="attachmentsid" class="form-control" value="">
                        </div>
