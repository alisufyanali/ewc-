        ...
        <div class="row">
            <div class="col-md-12" id="small-table">
                <div class="panel_s">
                                ...
                                <div class="panel panel-info col-md-12 panel-padding">
                                    ...
                                    <div class="panel-body">
                                        <table>
                                            <tr>
                                                ...
                                                <p>
                                                    ...
                                                    <p class="bold text-center"><span class="bold text-center">
                                                            <?php echo _l('stock_received_docket_number'); ?>:
                                                        </span>
                                                        <?php echo html_entity_decode($goods_receipt->goods_receipt_code) ?>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr class="project-overview">
                                                    <td class="bold" width="30%">
                                                        <?php echo _l('supplier_name'); ?>
                                                    </td>
                                                    <?php 
														if(get_status_modules_wh('purchase') && ($goods_receipt->supplier_code != '') && ($goods_receipt->supplier_code != 0) ){ ?>
                                                    <td>
                                                        <?php echo html_entity_decode(wh_get_vendor_company_name($goods_receipt->supplier_code)) ; ?>
                                                    </td>
                                                    <?php   }else{?>
                                                    <td>
                                                        <?php echo html_entity_decode($goods_receipt->supplier_name) ; ?>
                                                    </td>
                                                    <?php   }
                                                ...
                                                <tr class="project-overview">
                                                    ...
                                                    <td>
                                                        <?php echo html_entity_decode($goods_receipt->date_add) ; ?>
                                                    </td>
                                                </tr>
                                                <?php 
                                                ...
                                                <tr class="project-overview">
                                                    <td class="bold">
                                                        <?php echo _l('reference_purchase_order'); ?>
                                                    </td>
                                                    <td> <a
                                                            href="<?php echo admin_url('purchase/purchase_order/'.$goods_receipt->pr_order_id) ?>">
                                                            <?php echo get_pur_order_name($goods_receipt->pr_order_id) ?>
                                                        </a> </td>
                                                </tr>
                                                <?php   }
													} 
                                                ...
                                                <tr class="project-overview">
                                                    ...
                                                    <td>
                                                        <?php echo html_entity_decode($goods_receipt->description) ; ?>
                                                    </td>
                                                </tr>
                                                <tr style="display: none !important">
                                                    ...
                                                    <td>
                                                        <div class="btn-group"> <a href="#"
                                                                ...
                                                                aria-expanded="false"><i class="fa fa-file-pdf-o"></i>
                                                                <?php if(is_mobile()){echo ' PDF';} ?> <span
                                                                    class="caret"></span>
                                                            </a>
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <li class="hidden-xs">
                                                                    <a href="<?php echo admin_url('warehouse/stock_import_pdf/'.$goods_receipt->id.'?output_type=I'); ?>"
                                                                        target="_blank">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="<?php echo admin_url('warehouse/stock_import_pdf/'.$goods_receipt->id); ?>">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo html_entity_decode($receipt_key) ?>
                                                        </td>
                                                        <td>
                                                            <?php echo html_entity_decode(wh_get_item_variatiom($receipt_value->commodity_code)) ?>
                                                        </td>
                                                        <td>
                                                            <?php echo getLongDescription($receipt_value->commodity_code) ?>
                                                        </td>
                                                        <td>
                                                            <?php echo getFeetst($receipt_value->commodity_code) ?>
                                                        </td>
                                                        <td>
                                                            <?php echo getMeterst($receipt_value->commodity_code) ?>
                                                        </td>
                                                        <td class="text-right">
                                                            <?php echo html_entity_decode($quantities) ?>
                                                        </td>
                                                        <td class="text-right">
                                                            <?php echo app_format_money((float)$unit_price,'') ?>
                                                        </td>
                                                        <td class="text-right">
                                                            <?php echo app_format_money((float)$tax_money,'') ?>
                                                        </td>
                                                        <td class="text-right">
                                                            <?php echo app_format_money((float)$goods_money,'') ?>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo  app_format_money((float) ($goods_receipt->total_goods_money+$goods_receipt->discount), $base_currency)  ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bold" width="30%">
                                                            ...
                                                            <td>
                                                                <?php echo  app_format_money((float) $goods_receipt->discount, $base_currency)  ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bold" width="30%">
                                                            ...
                                                            <td>
                                                                <?php echo  app_format_money((float) $goods_receipt->total_goods_money, $base_currency)  ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bold" width="30%">
                                                            ...
                                                            <td>
                                                                <?php echo app_format_money((float) $goods_receipt->value_of_inventory, $base_currency) ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="bold ">
                                                                <?php echo  _l('total_tax_money')  ?> :
                                                            </td>
                                                            <td>
                                                                <?php echo app_format_money((float) $goods_receipt->total_tax_money, $base_currency) ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bold ">
                                                            ...
                                                            <td>
                                                                <?php echo  app_format_money((float) $goods_receipt->total_money, $base_currency)  ?>
                                                            </td>
                                                        </tr>
                                                        <tr></tr>
                                                    </tbody>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <p><span class="bold">
                                                        <?php echo _l('deliver_name') ?>
                                                    </span>
                                                </p>
                                                <p><span class="span-font-style">
                                                        <?php echo _l('sign_full_name') ?>
                                                    </span>
                                                </p>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <a data-toggle="tooltip" data-loading-text="<?php echo _l('wait_text'); ?>"
                                                ...
                                                href="#"
                                                onclick="send_request_approve(<?php echo html_entity_decode($goods_receipt->id); ?>); return false;">
                                                <?php echo _l('send_request_approve'); ?>
                                            </a>
                                            <?php } ?>
                                            ...
                                            <div class="btn-group">
                                                <a href="#" class="btn btn-success dropdown-toggle"
                                                    ...
                                                    <?php echo _l('approve'); ?><span class="caret"></span>
                                                </a>
                                                    ...
                                                    <li>
                                                        <div class="row text-right col-md-12">
                                                            <a href="#"
                                                                ...
                                                                onclick="approve_request(<?php echo html_entity_decode($goods_receipt->id); ?>); return false;"
                                                                class="btn btn-success button-margin">
                                                                <?php echo _l('approve'); ?>
                                                            </a>
                                                            <a href="#"
                                                                data-loading-text="<?php echo _l('wait_text'); ?>"
                                                                onclick="deny_request(<?php echo html_entity_decode($goods_receipt->id); ?>); return false;"
                            ...
                            <div class="col-md-3" style="display: none !important">
                                <div class="panel panel-info col-md-12 panel-padding">
                                    <div class="panel-heading ">
                                        <?php echo _l('approval_information'); ?>
                                    </div>
                                    <div class="panel-body">
                                        <h5 class="no-margin">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="text">
                                                            ...
                                                            <a
                                                                ...
                                                                <?php echo staff_profile_image($log['staffid'],array('staff-profile-xs-image','pull-left mright10')); ?>
                                                            </a>
                                                            <?php }?>
                                                            <p class="mtop10 no-mbot">
                                                                <?php echo html_entity_decode($fullname) . ' - <b>'.
																								_l($log['note']).'</b>'; ?>
                                                            </p>
                                                        </div>
                                                    </div>
                    ...
                    <!--                    class="btn btn-default text-right mright5 close_button">-->
                    <!--                    <?php echo _l('close'); ?>-->
                    <!--                </a>-->
                    <!--            </div>-->
                    <!--            <div class="btn-bottom-toolbar text-right">-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="sign_request(<?php echo html_entity_decode($goods_receipt->id); ?>);"
                    autocomplete="off" class="btn btn-success sign_request_class">
                    <?php echo _l('e_signature_sign'); ?>
                </button>
            </div>
        </div>
