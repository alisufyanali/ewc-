			...
			<div class="col-md-12" id="small-table">
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<input type="hidden" name="subtotals" id="subtotals" value="<?php echo $goods_receipt->subtotals; ?>">
							...
							<?php if(ACTIVE_PROPOSAL == true){ ?>
								...
								<div class="col-md-3 form-group <?php if($pr_orders_status == false){ echo 'hide';} ;?>" >
									...
									<select name="type" id="type" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
										<option value=""></option>
										<option value="GST" <?php if(isset($goods_receipt) && $goods_receipt->type == 'GST'){ echo 'selected';} ?>>POSTED</option>
										<option value="NON GST" <?php if(isset($goods_receipt) && $goods_receipt->type == 'NON GST'){ echo 'selected';} ?>>NON POSTED</option>
									</select>
								</div>
