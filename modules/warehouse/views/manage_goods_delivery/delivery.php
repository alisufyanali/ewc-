                    ...
                    <div class="panel-body mtop10 invoice-item">
                      ...
                      <div class="table-responsive s_table ">
                        <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                          <thead>
                            <tr>
                              <th></th>
                              <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> Product</th>
                      ...
                      <div class="col-md-8 col-md-offset-4">
                        <table class="table text-right">
                          <tbody>
                            <tr id="subtotal"  style="display: none !important">
                            ...
                            <tr id="total_discount"  style="display: none !important">
                            ...
                            <tr id="totalmoney"  style="display: none !important">
