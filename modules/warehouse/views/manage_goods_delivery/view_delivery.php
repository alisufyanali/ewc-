                           ...
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                            ...
                            ?>
                              ...
                              <td ><?php echo html_entity_decode($delivery) ?></td>
                                  ...
                                  <td ><?php echo get_commodity_name($delivery_value['commodity_code'])->Feet ?></td>
                                  <td ><?php echo get_commodity_name($delivery_value['commodity_code'])->Meters ?></td>
                                  <td ><?php echo get_commodity_name($delivery_value['commodity_code'])->sku_code ?></td>
                                  <td><?php echo get_commodity_name($delivery_value['commodity_code'])->long_description ?></td>
