						...
						<div class="row">
							<div class="col-md-12">
									...
									<table class="table items items-preview estimate-items-preview" data-type="estimate">
										<thead>
											<tr>
                                                        ...
                                                        <th  colspan="1" class="text-center">Feet</th>
                                                        <th  colspan="1" class="text-center">Meter</th>
                                                        <th  colspan="1" class="text-center">SKU Code</th>
                              ...
                              <td ><?php echo html_entity_decode($delivery) ?></td>
                                  ...
                                  <td ><?php echo get_commodity_name($packing_list_value['commodity_code'])->Feet ?></td>
                                  <td ><?php echo get_commodity_name($packing_list_value['commodity_code'])->Meters ?></td>
                                  <td ><?php echo get_commodity_name($packing_list_value['commodity_code'])->sku_code ?></td>
                                  <td><?php echo get_commodity_name($packing_list_value['commodity_code'])->long_description ?></td>
                                  <td class="text-right"><?php echo html_entity_decode($quantity) ?></td>
                                </tr>
