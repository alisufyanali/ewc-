                ...
                <?php echo form_hidden('proposal_id',$proposal_id); ?>
                  ...
                  <div class="row">
                    <div class=" col-md-3">
                      ...
                      <select name="warehouse_filter[]" id="warehouse_filter" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="Supplier">

                          <?php foreach($warehouse_filter as $warehouse) { ?>
                            <option value="<?php echo html_entity_decode($warehouse['userid']); ?>"><?php echo html_entity_decode($warehouse['company']); ?></option>
                            <?php } ?>
                        </select>
                        </div>
                    </div>
                    ...
                    <div class=" col-md-3">
                      <div class="form-group">
                      <select name="subgroup_filter[]" id="subgroup_filter" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="Sub Category">

                          <?php foreach($sub_groups as $warehouse) { ?>
                            <option value="<?php echo html_entity_decode($warehouse['id']); ?>"><?php echo html_entity_decode($warehouse['sub_group_name']); ?></option>
                            <?php } ?>
                        </select>
                        </div>
                    </div>
                    ...
                    <div class=" col-md-3">
                      <div class="form-group">
                      <select name="group_filter[]" id="group_filter" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="Category Filter">

                          <?php foreach($groups as $warehouse) { ?>
                            <option value="<?php echo html_entity_decode($warehouse['id']); ?>"><?php echo html_entity_decode($warehouse['name']); ?></option>
                            <?php } ?>
                        </select>
                        </div>
                    </div>
                    ...
                    <div class=" col-md-3">
                      <?php $this->load->view('warehouse/item_include/item_select', ['select_name' => 'commodity_filter[]', 'id_name' => 'Category', 'multiple' => true, 'data_none_selected_text' => 'commodity']); ?>
                    </div>
                    ...
                    <div class=" col-md-3">
                      <div class="form-group">
                      <select name="qty_filter" id="qty_filter" class="selectpicker"  data-live-search="true" data-width="100%" data-none-selected-text="Filter For Availble Qty">
    ...
    <div class="modal-dialog ht-dialog-width">
      ...
      <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="horizontal-scrollable-tabs preview-tabs-top" style="display: none !important">
                  <div class="scroller arrow-left"><i class="fa fa-angle-left"></i></div>
                  <div class="scroller arrow-right"><i class="fa fa-angle-right"></i></div>
                  <div class="horizontal-tabs" style="display: none !important">
               ...
               <div class="tab-content">
                ...
                <!-- interview process start -->
                  <div role="tabpanel" class="tab-pane active" id="interview_infor">
                        <div class="row parent_item_hide" style="display: none !important">
                          <div class=" col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                  <?php echo render_input('description', 'Name'); ?>
                                </div>
                                <div class="col-md-3">
                                    <?php echo render_input('sku_code', 'sku_code','',''); ?>
                                </div>
                                <div class="col-md-3">
                                     <?php echo render_select('group_id',$commodity_groups,array('id','name'),'Category'); ?>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="initail_quantity">
                                        <label for="initail_quantity" class="control-label">Initail Quantity in Hand</label>
                                        <input type="" id="initail_quantity" name="initail_quantity" class="form-control" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="as_of_date">
                                        <label for="as_of_date" class="control-label">As Of Date</label>
                                        <input type="date" id="as_of_date" name="as_of_date" class="form-control" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <?php 
                                    $attr = array();
                                    echo render_input('rate', 'Tag Price','', 'number', $attr); ?>
                                </div>
                                
                                <div class="clearfix"></div>
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="Unit">
                                        <label for="Unit" class="control-label">Unit Of Measurement</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="Breadth">
                                        <label for="Breadth" class="control-label">Lenght</label>
                                        <input type="" id="Breadth" name="Breadth" class="form-control sizer" value="">
                                    </div>
                                </div>
                                
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="Width">
                                        <label for="Width" class="control-label">Width</label>
                                        <input type="" id="Width" name="Width" class="form-control sizer" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="Feet">
                                        <label for="Feet" class="control-label">Feet</label>
                                        <input type="" id="Feet" name="Feet" class="form-control" value="" readonly="">
                                    </div>
                                </div>
                                
                                <div class="clearfix"></div>
                                <div class="col-md-3">
                                    <div class="form-group" app-field-wrapper="Meters">
                                        <label for="Meters" class="control-label">Meters</label>
                                        <input type="" id="Meters" name="Meters" class="form-control" readonly="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                     <?php echo render_input('commodity_barcode', 'Barcode','','text'); ?>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                    <?php echo render_textarea('purchase_descrition', 'Purchase Description'); ?>
                              </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                     <?php echo render_select('commodity_type',$vendor,array('userid','company'),'Supplier'); ?>
                            </div>
...
<script>
$("#sku_code").keyup(function(){
    var skucode = $("#sku_code").val();
    $("#commodity_code").val(skucode);
});
...
$(".sizer").keyup(function(){
    var width = $("#Width").val();
    var height = $("#Breadth").val();
    var type = $("#Height").val();
    if(type == "Feet"){
        var feet = width * height;
        var meter = feet / 10.76;
        $("#Feet").val(Math.round(feet));
        $("#Meters").val(meter.toFixed(2));
    }
    else{
        var feet = width * height;
        var meter = feet * 10.76;
        $("#Meters").val(feet.toFixed(2));
        $("#Feet").val(Math.round(meter));  
    }
    
    
    $('#description').val( description + ' ' + height + ' x ' + width);
