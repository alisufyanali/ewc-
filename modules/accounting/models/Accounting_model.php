...
class Accounting_model extends App_Model
{
    ...
    public function get_account_types()
    {
        $account_types = hooks()->apply_filters('before_get_account_types', [
            ...
            [
                ...
                [
                'id'             => 16,
                'name'           => _l('acc_accounts_assets'),
                'order'          => 16,
                ],
                [
                'id'             => 17,
                'name'           => _l('acc_accounts_revenue'),
                'order'          => 17,
                ],
            ]);
    ...
    public function get_account_type_details()
    {
        $account_type_details = hooks()->apply_filters('before_get_account_type_details', [
            ...
            [
                'id'                => 141,
                'account_type_id'   => 16,
                'name'              => _l('acc_scurrent_assets'),
                'note'              => _l('acc_scurrent_assets_note'),
                'order'             => 141,
                ],
            [
                'id'                => 142,
                'account_type_id'   => 16,
                'name'              => _l('acc_asfixed_assets'),
                'note'              => _l('acc_asfixed_assets_note'),
                'order'             => 142,
                ],
            [
                'id'                => 143,
                'account_type_id'   => 14,
                'name'              => _l('acc_ga_expense'),
                'note'              => _l('acc_ga_expense_note'),
                'order'             => 143,
                ],
            ]);
    ...
    public function get_account_type_details_type()
    {
        $get_account_type_details_type = hooks()->apply_filters('before_get_account_type_details_type', [
            [
                'id'                => 1,
                'account_type_id'   => 16,
                'account_type_id_type'   => 141,
                'name'              => 'Cash & Bank',
                'note'              => 'Cash & Bank',
                'order'             => 1,
                ],
            [
                ...
                'account_type_id'   => 16,
                'account_type_id_type'   => 141,
                'name'              => 'Advance & Prepayments',
                'note'              => 'Advance & Prepayments',
                'order'             => 2,
                ],
            [
                'id'                => 3,
            ...
            [
                ...
                'account_type_id'   => 16,
                'account_type_id_type'   => 142,
                'name'              => 'Accum Depreciation - PPE',
                'note'              => 'Accum Depreciation - PPE',
                'order'             => 5,
                ],
            [
                'id'                => 6,
            ...
            [
                ...
                'account_type_id'   => 16,
                'account_type_id_type'   => 142,
                'name'              => 'Amortization - Intangible',
                'note'              => 'Amortization - Intangible',
                'order'             => 7,
                ],
            [
                'id'                => 8,
                ...
                'note'              => 'Long Term Deposits',
                'order'             => 8,
                ],
            [
                'id'                => 9,
                'account_type_id'   => 14,
                'account_type_id_type'   => 143,
                'name'              => 'Salaries & Benefits',
                'note'              => 'Salaries & Benefits',
                'order'             => 9,
                ],
            [
                'id'                => 10,
            ...
            [
                ...
                'note'              => 'Depreciation & Amortization',
                'order'             => 17,
                ],
            [
                'id'                => 18,
            ...
            [
                'id'                => 21,
                'account_type_id'   => 8,
                'account_type_id_type'   => 54,
                'name'              => 'Long Term Financing',
                'note'              => 'Long Term Financing',
                'order'             => 21,
                ],
            [
                'id'                => 22,
        ...
        usort($get_account_type_details_type, function ($a, $b) {
            return $a['order'] - $b['order'];
        });
        
        
        return $get_account_type_details_type;

    }
    
    
    public function get_third_accounts()
    {
        $accounts = $this->accounting_model->get_account_type_details_type();
    ...
    public function get_accounts($id = '', $where = [])
    {
        ...
        foreach ($third_level_types as $key => $value) {
        ...
        foreach ($accounts as $key => $value) {
            ...
            $_detail_type_name = isset($detail_type_name[$value['account_detail_type_id']]) ? $detail_type_name[$value['account_detail_type_id']] : '';
             $_third_type_name = isset($third_level_name[$value['account_third_level']]) ? $third_level_name[$value['account_third_level']] : '';
            $accounts[$key]['account_type_name'] = $_account_type_name;
            $accounts[$key]['detail_type_name'] = $_detail_type_name;
            $accounts[$key]['third_level'] = $_third_type_name;
        }
    ...
    public function get_data_account_to_select() {
        ...
        foreach ($accounts as $key => $account) {
            ...
            $note['label'] = $account['name'].' - '.$account['HeadCode'];
    ...
    public function get_data_check_detail($data_filter){
        ...
        $customer  = $data_filter['supplierlist'];
        $accountlist = $data_filter['accountlist'];
        $from_date = date('Y-01-01');
        $to_date = date('Y-m-d');
        $acc_show_account_numbers = get_option('acc_show_account_numbers');
    ...
    public function get_max_jv_no() {
        
        $this->db->select('max(VNO) as max_VNO');
        $max = $this->db->get(db_prefix().'acc_journal_entries')->row();
        if($max->max_VNO !== null){
            $last_number = intval(substr($max->max_VNO, 3)); // Extract number part and convert to integer
            $new_number = 'JV-' . sprintf('%02d', $last_number + 1); // Increment and format number
            return $new_number;
        }
        return 'JV-01'; // If no existing number found, return the initial one
    }
    ...
    function get_account_data_tables($aColumns, $sIndexColumn, $sTable, $join = [], $where = [], $additionalSelect = [], $sGroupBy = '', $searchAs = [])
    {
        ...
        $this->db->select('id, number, name, parent_account, account_type_id, account_detail_type_id,account_third_level, balance, key_name, active, number, description,currency, balance_as_of, '.$debit.', '.$credit.', default_account');
    ...
    public function insert_batch_budget($data, $budget_id, $import_type){
        ...
        foreach($data as $value){
            if($import_type == 'month'){
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_1'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 1];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_2'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 2];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_3'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 3];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_4'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 4];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_5'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 5];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_6'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 6];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_7'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 7];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_8'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 8];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_9'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 9];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_10'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 10];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_11'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 11];
                $data_insert[] = ['budget_id' => $budget_id, 'amount' => $value['month_12'], 'year' => $budget->year, 'account' => $value['account'], 'month' => 12];
            }elseif($import_type == 'quarter'){
                if($value['quarter_1'] > 0)
                {
                    $value_1 = round($value['quarter_1']/3);
                    $value_2 = round($value['quarter_1']/3);
                    $value_3 = $value['quarter_1'] - $value_2 - $value_1;
                    
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 1, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_1];

                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 2, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_2];
               
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 3, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_3];

                }
                if($value['quarter_2'] > 0)
                {
                    $value_1 = round($value['quarter_2']/3);
                    $value_2 = round($value['quarter_2']/3);
                    $value_3 = $value['quarter_2'] - $value_2 - $value_1;

                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 4, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_1];
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 5, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_2];
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 6, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_3];
                }
                if($value['quarter_3'] > 0)
                {
                    $value_1 = round($value['quarter_3']/3);
                    $value_2 = round($value['quarter_3']/3);
                    $value_3 = $value['quarter_3'] - $value_2 - $value_1;

                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 7, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_1];
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 8, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_2];
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 9, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_3];
                }
                if($value['quarter_4'] > 0)
                {
                    $value_1 = round($value['quarter_4']/3);
                    $value_2 = round($value['quarter_4']/3);
                    $value_3 = $value['quarter_4'] - $value_2 - $value_1;

                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 10, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_1];
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 11, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_2];
                    $data_insert[] = ['budget_id' => $budget_id, 'month' => 12, 'year' => $budget->year, 'account' => $value['account'], 'amount' => $value_3];
                }
                ...
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 1, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 2, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 3, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 4, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 5, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 6, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 7, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 8, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 9, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 10, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 11, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_1];
                $data_insert[] = ['budget_id' => $budget_id, 'month' => 12, 'year' =>$budget->year, 'account' => $value['account'], 'amount' => $value_2];
            }
        }
    ...
    public function get_HeadCodeById($id) {
     ...
     * @return object     
     */
    public function get_payment_entry($id){
        $this->db->where('id', $id);
        $payment_entrie = $this->db->get(db_prefix() . 'acc_payment_entries')->row();
        ...
        if($payment_entrie){
            ...
            $payment_entrie->details = $data_details;
        }

        return $payment_entrie;
    }
     ...
     * @return boolean       
     */
    public function update_payment_entry($data, $id){
        $payment_entry = json_decode($data['payment_entry']);
        unset($data['payment_entry']);

        $data['payment_date'] = to_sql_date($data['payment_date']);
        if(get_option('acc_close_the_books') == 1){
            if(strtotime($data['payment_date']) <= strtotime(get_option('acc_closing_date')) && strtotime(date('Y-m-d')) > strtotime(get_option('acc_closing_date'))){
                return 'close_the_book';
            }
        }
    ...
    public function get_max_pv_no() {
        
        $this->db->select('max(VNO) as max_VNO');
        $max = $this->db->get(db_prefix().'acc_payment_entries')->row();
        if($max->max_VNO !== null){
            $last_number = intval(substr($max->max_VNO, 3)); // Extract number part and convert to integer
            $new_number = 'PV-' . sprintf('%02d', $last_number + 1); // Increment and format number
            return $new_number;
        }
