          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <?php echo form_open(admin_url('accounting/view_report'),array('id'=>'filter-form')); ?>
                ...
                <div class="col-md-4">
                  <label>Account</label>
                  <select class="selectpicker form-control" name="accountlist">
                      <option value=""></option>
                      <?php
                        foreach(get_accountsList() as $vendors){
                            echo '<option value="'.$vendors['id'].'">'.$vendors['name'].'</option>';    
                        }
                      ?>
                  </select>
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <select class="selectpicker form-control" name="supplierlist">
                      <option value=""></option>
                      <?php
                        foreach(get_AllSupplierList() as $vendors){
                            echo '<option value="'.$vendors['userid'].'">'.$vendors['company'].'</option>';    
                        }
                      ?>
                  </select>
                </div>
